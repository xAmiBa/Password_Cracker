# Import random module to create random data needed in the program.
import random
# Import string module to save time on writing character, digits and punctuation strings.
import string
# Import time module to measure password cracking time and implement timeout break.
import time
# Pyperclip module allows to copy text into users' clipboard.
import pyperclip
